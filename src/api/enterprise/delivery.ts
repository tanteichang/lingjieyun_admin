...
const API = {
  ...
  deliveryRecordList: '/admin/enterprise/member/deliveryRecordList',
};
...
export function getDeliveryRecordList(params: DeliveryRecordListPayload) {
  return getRequest<DeliveryRecordListResponse>({
    url: API.deliveryRecordList,
    params,
  });
}
