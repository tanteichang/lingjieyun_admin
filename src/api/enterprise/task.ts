...
const API = {
  ...
  DownloadRecruitTemplate: '/admin/enterprise/task/downloadRecruitTemplate',
...
export const batchRecruit = (params: BatchRecruitPayload) => {
  return postRequest<BatchRecruitResponse>({
    url: API.BatchRecruit,
    params,
    showError: true,
  });
};

export const recruit = (params: RecruitPayload) => {
  return postRequest<RecruitResponse>({
    url: API.Recruit,
    params,
    showError: true,
  });
...
export const removeMember = (params: RemoveMemberPayload) => {
